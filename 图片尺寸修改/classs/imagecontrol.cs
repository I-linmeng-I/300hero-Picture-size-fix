   ...
   sY + sH-hB, sY + sH-hB, sY + sH / 2};
        ...
        private void lbl_MouseMove(object sender, MouseEventArgs e)
        {
            ...
            if (dragging)
            {
                ...
                if(cixi == true)
                {
                    l = (l < m_control.Parent.ClientRectangle.Width / 64 && l > -m_control.Parent.ClientRectangle.Width / 64) ? 0 : l;
                    t = (t < m_control.Parent.ClientRectangle.Height / 40 && t > -m_control.Parent.ClientRectangle.Height / 40) ? 0 : t;
                    w = (l + w < m_control.Parent.ClientRectangle.Width + m_control.Parent.ClientRectangle.Width / 64 &&l+w> m_control.Parent.ClientRectangle.Width - m_control.Parent.ClientRectangle.Width / 64) ? m_control.Parent.ClientRectangle.Width - l : w;
                    h = (t + h > m_control.Parent.ClientRectangle.Height + m_control.Parent.ClientRectangle.Height / 40 && t + h > m_control.Parent.ClientRectangle.Height - m_control.Parent.ClientRectangle.Height / 40) ? m_control.Parent.ClientRectangle.Height - t : h;
                }
        ...
        private void ctl_MouseMove(object sender, MouseEventArgs e)
        {
            if (dragging)
            {
                ...
                int w = m_control.Width;
                int h = m_control.Height;
                l = cixi ? (l < m_control.Parent.ClientRectangle.Width/64 &&l> -m_control.Parent.ClientRectangle.Width/64) ? 0 : ((l + w < m_control.Parent.ClientRectangle.Width + m_control.Parent.ClientRectangle.Width/64 && l + w > m_control.Parent.ClientRectangle.Width - m_control.Parent.ClientRectangle.Width / 64) ?
                    m_control.Parent.ClientRectangle.Width - w : l):l;
                t =cixi ? (t < m_control.Parent.ClientRectangle.Height/40 && t> -m_control.Parent.ClientRectangle.Height/40) ? 0 : ((t + h < m_control.Parent.ClientRectangle.Height+ m_control.Parent.ClientRectangle.Height/40&& t + h > m_control.Parent.ClientRectangle.Height - m_control.Parent.ClientRectangle.Height / 40) ?
                    m_control.Parent.ClientRectangle.Height - h : t):t;
                m_control.Left = l;
                m_control.Top = t;
            }
        }
